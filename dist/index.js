(function (factory) {
    ...
    var isType$1 = function (value, type) { return toString$3.call(value) === '[object ' + type + ']'; };
    ...
    class Base$2 extends EventEmit {
      getDefaultCfg() {
        return {};
      }
    ...
    class Shape$2 extends AttributeBase {
      constructor(cfg) {
        super(cfg);
        this.names = ['shape'];
        this.type = 'shape';
        ...
        for (var k in attrs) {
          if (attrs.hasOwnProperty(k)) {
            ...
            for (var i = 0, len = data.length; i < len; i++) {
              ...
              var mappedRecord = _objectSpread$1(_objectSpread$1({}, record), mappedData[i]);
    ...
    ***************************************************************************** */
    ...
    function extended(dmin, dmax, m, onlyLoose, Q, w) {
        ...
        var ticks = toFixed ? map$1(range, function (x) { return Number.parseFloat(x.toFixed(toFixed)); }) : range;
        return {
    ...
    var D3Linear = /** @class */ (function () {
        ...
        D3Linear.prototype.nice = function (count) {
            var _a, _b;
            if (count === void 0) { count = DEFAULT_COUNT$1; }
    ...
    class Line$3 extends Abastract {
      _initDefaultCfg() {
    ...
    class EventController {
      constructor(_ref) {
        ...
        _defineProperty$5(this, "_click", function (ev) {
        ...
        _defineProperty$5(this, "_start", function (ev) {
          var points = convertPoints(ev, _this.canvas);
        ...
        _defineProperty$5(this, "_move", function (ev) {
          var points = convertPoints(ev, _this.canvas);
          if (!points) return;
        ...
        _defineProperty$5(this, "_end", function (ev) {
          var points = convertPoints(ev, _this.canvas);
          ev.points = points;
        ...
        _defineProperty$5(this, "_cancel", function (ev) {
    ...
    class ImageShape extends Rect$2 {
      _initProperties() {
        super._initProperties();
    ...
    class Circle extends Abastract {
      _initDefaultCfg() {
        super._initDefaultCfg();
    ...
    class TooltipController {
      constructor(cfg) {
        ...
        _defineProperty$4(this, "handleShowEvent", function (ev) {
        ...
        _defineProperty$4(this, "handleHideEvent", function () {
          if (!_this.enable) return;
    ...
    */
    ...
    class Context {
      ...
      constructor(chart) {
        ...
        _defineProperty$1(this, "chart", null);

        _defineProperty$1(this, "values", null);

        _defineProperty$1(this, "range", defaultRange);

        _defineProperty$1(this, "startRange", defaultRange);

        _defineProperty$1(this, "minCount", 10);

        _defineProperty$1(this, "_afterinit", function () {
          // 初始化value值
        ...
        _defineProperty$1(this, "_afterdatachange", function () {
          _this.updateRange(_this.range);
        });
